...
export class QuizzComponent implements OnInit {
  ...
  async nextStep(){
    ...
    if(this.questionMaxIndex > this.questionIndex){
      ...
      const finalAnswer:string = await this.checkResult(this.awnser)
      this.finished = true
      this.awnserSelected = quizz_questions.results[finalAnswer as keyof typeof quizz_questions.results]
